...
func TestRpcReqProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, false)
...
func TestRpcReqMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, false)
	size := p.Size()
...
func BenchmarkRpcReqProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*RpcReq, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedRpcReq(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkRpcReqProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedRpcReq(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestRpcReqJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, true)
...
func TestRpcReqProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, true)
...
func TestRpcReqProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, true)
...
func TestRpcReqVerboseEqual(t *testing.T) {
...
func TestRpcReqGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRpcReq(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestRpcReqSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedRpcReq(popr, true)
...
func BenchmarkRpcReqSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*RpcReq, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedRpcReq(popr, false)
	}
	b.ResetTimer()
...
func TestRpcReqStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedRpcReq(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
