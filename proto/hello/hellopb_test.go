...
func TestHelloReqProto(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, false)
...
func TestHelloReqMarshalTo(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, false)
	size := p.Size()
...
func BenchmarkHelloReqProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*HelloReq, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedHelloReq(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkHelloReqProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedHelloReq(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func TestHelloReqJSON(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, true)
...
func TestHelloReqProtoText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, true)
...
func TestHelloReqProtoCompactText(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, true)
...
func TestHelloReqVerboseEqual(t *testing.T) {
...
func TestHelloReqGoString(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedHelloReq(popr, false)
	s1 := p.GoString()
	s2 := fmt.Sprintf("%#v", p)
...
func TestHelloReqSize(t *testing.T) {
	seed := time.Now().UnixNano()
	popr := math_rand.New(math_rand.NewSource(seed))
	p := NewPopulatedHelloReq(popr, true)
...
func BenchmarkHelloReqSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*HelloReq, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedHelloReq(popr, false)
	}
	b.ResetTimer()
...
func TestHelloReqStringer(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedHelloReq(popr, false)
	s1 := p.String()
	s2 := fmt.Sprintf("%v", p)
